...
<div class="album py-5 bg-body-tertiary">
    <h2 class="text-center">Latest gigs</h2>
                ...
                <div class="col">
                    <div class="card text-center mt-4 rounded-5">
                        ...
                        <div class="card-body">
                            ...
                            <a href="single-gig.php?id=<?= $row['g_id'] ?>"
    ...
    <script>
        $(document).ready(function () {
            function updateGigs() {
                ...
                $.ajax({
                    type: "POST",
                    url: "filter_gigs.php", // Update with your actual PHP file
                    data: {
                        location: location,
                        price: price,
                        rank: rank
